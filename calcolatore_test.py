...
# ── TAVOLA A.10 — Autovalutazione compositi (somma Pp → composito) ───
# Norma fascia 22-29 applicata a tutte le fasce (fonte: manuale, OCR).
# Verificare valori critici sul cartaceo per età >29 e <22.
TAVOLA_A10 = {
    "gac_sl": _inv({40:9, 47:72, 48:73, 49:75, 50:77, 51:79, 52:80, 53:82, 55:86, 56:88,
                    57:90, 58:91, 59:93, 60:95, 61:97, 62:99, 63:100, 64:102, 65:104,
                    66:105, 67:107, 68:108, 69:110, 70:111, 71:112, 72:113, 73:114,
                    75:116, 76:117, 78:119, 79:120}),
    "gac_cl": _inv({47:81, 48:82, 49:84, 50:86, 51:88, 52:90, 53:92, 55:96, 56:98,
                    57:100, 58:102, 59:104, 60:106, 61:108, 62:110, 63:111, 64:113,
                    65:115, 66:117, 67:118, 68:120, 69:122, 70:123, 71:124, 72:126,
                    73:127, 75:130, 76:131, 78:133, 79:134}),
    "dac":    _inv({47:23, 49:24, 51:25, 52:26, 53:27, 55:28, 56:29, 57:30, 59:31,
                    60:32, 61:33, 63:34, 65:35, 67:36, 69:37, 72:38, 75:39, 79:40}),
    "das":    _inv({49:17, 52:18, 55:19, 57:20, 58:21, 60:22, 63:23, 66:24, 70:25,
                    75:26, 79:27}),
    "dap_sl": _inv({40:4, 47:33, 48:34, 49:35, 50:36, 51:37, 52:38, 53:39, 55:40,
                    56:41, 57:42, 59:43, 61:44, 62:45, 64:46, 66:47, 69:48, 72:49,
                    75:50, 78:51, 79:52}),
    "dap_cl": _inv({47:42, 48:43, 49:44, 50:46, 51:47, 52:48, 53:49, 55:50, 56:51,
                    57:52, 58:53, 59:54, 61:55, 62:56, 63:57, 65:58, 67:59, 69:60,
                    71:61, 73:62, 76:63, 79:64}),
}
...
def calcola_abas_autovalutazione(dati):
    ...
    fascia = fascia_eta(eta)
    if not fascia:
        return {"Forma": "Autovalutazione adulto", "Nota": f"Età {eta} fuori range (16-74)"}
    ...
    res = _calcola_abas_forma(
        grezzi_f, TAVOLA_A9[fascia], TAVOLA_A10, fascia, ha_lavoro=ha_lavoro,
        dominio_pratico_sl=["am","vc","ss","cur"],
        dominio_pratico_cl=["am","vc","ss","cur","lav"],
        forma_nome="Autovalutazione adulto (16-74)"
    )
    res["Nota"] = "Compositi A.10 normalizzati su fascia 22-29; verificare valori critici su manuale per età diverse."
    return res
